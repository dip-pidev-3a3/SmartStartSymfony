...
class __TwigTemplate_8ce9d33bcc9713f4b4b60ae992c74f8f438e706679b7ca19027f0472eb3f3a49 extends Twig_Template
{
            ...
            if (((isset($context["profiler_markup_version"]) ? $context["profiler_markup_version"] : $this->getContext($context, "profiler_markup_version")) == 1)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                    ...
                    echo "</b>
                        <span>";
                    // line 27
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "messageCount", [0 => $context["name"]], "method"), "html", null, true);
                    echo "</span>
                    </div>
                    <div class=\"sf-toolbar-info-piece\">
                        ...
                        <span>";
                    // line 31
                    echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "isSpool", [0 => $context["name"]], "method")) ? ("yes") : ("no"));
                    echo "</span>
                    </div>
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                    ...
                    echo " mailer</b>
                        <span class=\"sf-toolbar-status\">";
                    // line 42
                    echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "messageCount", [0 => $context["name"]], "method", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "messageCount", [0 => $context["name"]], "method"), 0)) : (0)), "html", null, true);
                    echo "</span>
                        &nbsp; (<small>";
                    // line 43
                    echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "isSpool", [0 => $context["name"]], "method")) ? ("spooled") : ("sent"));
                    echo "</small>)
                    </div>
                ";
                }
    ...
    <span class=\"label ";
        // line 56
        echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "messageCount", [])) ? ("") : ("disabled"));
        echo "\">
        ";
        // line 57
        if (((isset($context["profiler_markup_version"]) ? $context["profiler_markup_version"] : $this->getContext($context, "profiler_markup_version")) == 1)) {
        ...
        ";
        // line 64
        if (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "messageCount", []) > 0)) {
            // line 65
...
";
    ...
    ";
        // line 89
        if ( !$this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "mailers", [])) {
            // line 90
    ...
    ";
        // line 95
        if ((((isset($context["profiler_markup_version"]) ? $context["profiler_markup_version"] : $this->getContext($context, "profiler_markup_version")) == 1) || (twig_length_filter($this->env, $this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "mailers", [])) > 1))) {
            // line 96
            echo "        <table>
            <thead>
                <tr>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                ...
                echo "</td>
                        <td class=\"font-normal\">";
                // line 111
                echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "isDefaultMailer", [0 => $context["name"]], "method")) ? ("This is the default mailer") : (""));
                echo "</td>
                    </tr>
                ";
            }
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                ...
                echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "isSpool", [0 => $context["name"]], "method")) ? ("spooled") : ("sent"));
                echo " ";
                echo ((($this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "messageCount", [0 => $context["name"]], "method") == 1)) ? ("message") : ("messages"));
                echo "</span>
                </div>
            ";
            }
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
            // line 128
            echo "        ";
            if ((twig_length_filter($this->env, $this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "mailers", [])) > 1)) {
                // line 129
                echo "            <h3>
                ";
                // line 130
                ...
                <small>";
                // line 131
                echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "isDefaultMailer", [0 => $context["name"]], "method")) ? ("(default app mailer)") : (""));
                echo "</small>
            </h3>
        ";
            }
        ...
        ";
            // line 135
            if ( !$this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "messages", [0 => $context["name"]], "method")) {
                // line 136
                echo "            <div class=\"empty\">
                <p>No e-mail messages were sent.</p>
            </div>
        ";
                ...
                echo "            ";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "messages", [0 => $context["name"]], "method"));
                $context['loop'] = [
                  'parent' => $context['_parent'],
                  'index0' => 0,
                  'index'  => 1,
                ...
                <div class=\"card\">
                    ...
                    <div class=\"card-block\">
                        ...
                        <pre>";
                    // line 158
                    if (($this->getAttribute((isset($context["messagePart"]) ? $context["messagePart"] : null), "charset", [], "any", true, true) && $this->getAttribute($context["message"], "charset", []))) {
                        // line 159
                    ...
                    ";
                    // line 179
                    $context["attachments"] = $this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "extractAttachments", [0 => $context["message"]], "method");
                    // line 180
                    echo "                    ";
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Swiftmailer/Collector/swiftmailer.html.twig", "C:\\wamp64\\www\\SmartStartSymfony-master\\vendor\\symfony\\swiftmailer-bundle\\Resources\\views\\Collector\\swiftmailer.html.twig");
    }
}
