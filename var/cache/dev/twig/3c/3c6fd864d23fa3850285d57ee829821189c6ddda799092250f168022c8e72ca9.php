...
class __TwigTemplate_126ed829176d3e3cfe29d09c850f3adc184b6961bdb1eb3c8c6b19bdc42b87dd extends Twig_Template
{
...
";
    ...
    public function block_subject($context, array $blocks = [])
    {
        ...
        // line 4
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("resetting.email.subject", ["%username%" => $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "username", [])], "FOSUserBundle");
...
", "FOSUserBundle:Resetting:email.txt.twig", "C:\\wamp\\www\\SmartStartSymfony\\vendor\\friendsofsymfony\\user-bundle/Resources/views/Resetting/email.txt.twig");
    }
}
