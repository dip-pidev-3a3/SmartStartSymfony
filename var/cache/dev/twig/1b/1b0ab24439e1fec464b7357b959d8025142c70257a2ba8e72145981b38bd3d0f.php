...
class __TwigTemplate_4be121120cdddd54fdf2de60f676a2c96f5aca16506182389e4330bcdf6880a4 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo ((twig_test_empty($this->getAttribute((isset($context["exception"]) ? $context["exception"] : $this->getContext($context, "exception")), "message", []))) ? ("exception-without-message") : (""));
        echo "\">
    <div class=\"exception-metadata\">
        ...
        $context['_seq'] = twig_ensure_traversable(twig_reverse_filter($this->env, $this->getAttribute((isset($context["exception"]) ? $context["exception"] : $this->getContext($context, "exception")), "allPrevious", [])));
        $context['loop'] = [
    ...
    <div class=\"exception-message-wrapper\">
        ...
        // line 19
        echo (((twig_length_filter($this->env, $this->getAttribute((isset($context["exception"]) ? $context["exception"] : $this->getContext($context, "exception")), "message", [])) > 180)) ? ("long") : (""));
        echo "\">";
        // line 20
...
<div class=\"container\">
    <div class=\"sf-tabs\">
        <div class=\"tab\">
            ";
        // line 33
        $context["exception_as_array"] = $this->getAttribute((isset($context["exception"]) ? $context["exception"] : $this->getContext($context, "exception")), "toarray", []);
        // line 34
        echo "            ";
        ...
        foreach ($context['_seq'] as $context["i"] => $context["e"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["trace"]) {
                ...
                if (((( !twig_test_empty($this->getAttribute($context["trace"], "file", [])) && !twig_in_filter("/vendor/", $this->getAttribute($context["trace"], "file", []))) && !twig_in_filter("/var/cache/", $this->getAttribute($context["trace"], "file", []))) &&  !$this->getAttribute($context["loop"], "last", []))) {
                    // line 38
                    echo "                        ";
                    $context["_exceptions_with_user_code"] = twig_array_merge((isset($context["_exceptions_with_user_code"]) ? $context["_exceptions_with_user_code"] : $this->getContext($context, "_exceptions_with_user_code")), [0 => $context["i"]]);
                    // line 39
                    echo "                    ";
                }
                // line 40
        ...
        foreach ($context['_seq'] as $context["i"] => $context["e"]) {
            // line 52
            echo "                    ";
            echo twig_include($this->env, $context, "@Twig/Exception/traces.html.twig", ["exception" => $context["e"], "index" => $this->getAttribute($context["loop"], "index", []), "expand" => (twig_in_filter($context["i"], (isset($context["_exceptions_with_user_code"]) ? $context["_exceptions_with_user_code"] : $this->getContext($context, "_exceptions_with_user_code"))) || (twig_test_empty((isset($context["_exceptions_with_user_code"]) ? $context["_exceptions_with_user_code"] : $this->getContext($context, "_exceptions_with_user_code"))) && $this->getAttribute($context["loop"], "first", [])))], false);
            echo "
                ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
        ...
        if ((isset($context["logger"]) ? $context["logger"] : $this->getContext($context, "logger"))) {
            // line 58
            echo "        <div class=\"tab ";
            echo ((twig_test_empty($this->getAttribute((isset($context["logger"]) ? $context["logger"] : $this->getContext($context, "logger")), "logs", []))) ? ("disabled") : (""));
            echo "\">
            <h3 class=\"tab-title\">
                Logs
                ";
            // line 61
            if (((($this->getAttribute((isset($context["logger"]) ? $context["logger"] : null), "counterrors", [], "any", true, true) &&  !(null === $this->getAttribute((isset($context["logger"]) ? $context["logger"] : null), "counterrors", [])))) ? ($this->getAttribute((isset($context["logger"]) ? $context["logger"] : null), "counterrors", [])) : (false))) {
            ...
            <div class=\"tab-content\">
                ";
            // line 65
            if ($this->getAttribute((isset($context["logger"]) ? $context["logger"] : $this->getContext($context, "logger")), "logs", [])) {
                // line 66
                echo "                    ";
                echo twig_include($this->env, $context, "@Twig/Exception/logs.html.twig", ["logs" => $this->getAttribute((isset($context["logger"]) ? $context["logger"] : $this->getContext($context, "logger")), "logs", [])], false);
                echo "
                ";
            } else {
                // line 68
...
", "@Twig/Exception/exception.html.twig", "C:\\wamp64\\www\\SmartStartSymfony-master\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle\\Resources\\views\\Exception\\exception.html.twig");
    }
}
