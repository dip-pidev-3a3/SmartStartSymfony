...
class __TwigTemplate_d3b693928dac57cf78579e64e292675d99ff879141ba74b7e03f292d6755b83e extends Twig_Template
{
    ...
    <div class=\"trace-details\">
        ...
        foreach ($context['_seq'] as $context["i"] => $context["trace"]) {
            // line 25
            echo "            ";
            $context["_display_code_snippet"] = (((($context["_is_first_user_code"] ?? $this->getContext($context, "_is_first_user_code")) && !twig_in_filter("/vendor/", $this->getAttribute($context["trace"], "file", []))) && !twig_in_filter("/var/cache/", $this->getAttribute($context["trace"], "file", []))) &&  !twig_test_empty($this->getAttribute($context["trace"], "file", [])));
            // line 26
            echo "            ";
            ...
            echo "            <div class=\"trace-line\">
                ";
            // line 28
            echo twig_include($this->env, $context, "@Twig/Exception/trace.html.twig", ["prefix" => ($context["index"] ?? $this->getContext($context, "index")), "i" => $context["i"], "trace" => $context["trace"], "_display_code_snippet" => ($context["_display_code_snippet"] ?? $this->getContext($context, "_display_code_snippet"))], false);
            echo "
            </div>
        ";
        }
...
", "@Twig/Exception/traces.html.twig", "/Applications/MAMP/htdocs/SmartStartSymfony/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/traces.html.twig");
    }
}
