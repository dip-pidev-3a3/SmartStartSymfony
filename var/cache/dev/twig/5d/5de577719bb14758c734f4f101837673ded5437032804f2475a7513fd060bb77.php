...
class __TwigTemplate_06987a116f846fcd37533b54ca84a2310da4f87d28df986fe1cb436fd85a4bbc extends Twig_Template
{
...
";
    ...
    public function block_subject($context, array $blocks = [])
    {
        ...
        // line 4
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("resetting.email.subject", ["%username%" => $this->getAttribute(($context["user"] ?? $this->getContext($context, "user")), "username", [])], "FOSUserBundle");
...
", "FOSUserBundle:Resetting:email.txt.twig", "C:\\wamp\\www\\SmartStartSymfony-push\\vendor\\friendsofsymfony\\user-bundle/Resources/views/Resetting/email.txt.twig");
    }
}
