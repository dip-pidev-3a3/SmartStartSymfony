...
class __TwigTemplate_97836e8544d070f294f4e6ed431f1dc49c29d25f9121509210131904d21326db extends Twig_Template
{
...
<div class=\"metrics\">
    <div class=\"metric\">
        <span class=\"value\">";
        // line 5
        echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["request"]) ? $context["request"] : $this->getContext($context, "request")), "route", [])) ? ($this->getAttribute((isset($context["request"]) ? $context["request"] : $this->getContext($context, "request")), "route", [])) : ("(none)")), "html", null, true);
        echo "</span>
...
";
    ...
    ";
            // line 20
            if (twig_test_empty($this->getAttribute((isset($context["request"]) ? $context["request"] : $this->getContext($context, "request")), "routeParams", []))) {
                // line 21
    ...
    ";
                ...
                // line 25
                echo "        ";
                echo twig_include($this->env, $context, "@WebProfiler/Profiler/table.html.twig", ["data" => $this->getAttribute((isset($context["request"]) ? $context["request"] : $this->getContext($context, "request")), "routeParams", []), "labels" => [0 => "Name", 1 => "Value"]], false);
                echo "
    ";
            }
        }
...
", "WebProfilerBundle:Router:panel.html.twig", "C:\\wamp\\www\\SmartStartSymfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views/Router/panel.html.twig");
    }
}
