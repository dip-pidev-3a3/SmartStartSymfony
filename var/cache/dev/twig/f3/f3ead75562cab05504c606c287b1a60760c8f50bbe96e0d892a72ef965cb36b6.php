...
class __TwigTemplate_9a98b9b50db429dfede211409c74575b61a96ea1496c4ff6ec521e190f6fcdd3 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (twig_length_filter($this->env, $this->getAttribute(($context["exception"] ?? $this->getContext($context, "exception")), "trace", []))) {
            // line 2
            echo $this->getAttribute(($context["exception"] ?? $this->getContext($context, "exception")), "class", []);
            echo ":
";
            // line 3
            if ( !twig_test_empty($this->getAttribute(($context["exception"] ?? $this->getContext($context, "exception")), "message", []))) {
                // line 4
...
{% endfor %}
{% endif %}
", "@Twig/Exception/traces.txt.twig", "/Applications/MAMP/htdocs/SmartStartSymfony/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/traces.txt.twig");
    }
}
