...
class __TwigTemplate_b4ec74789cd40972abcb84265369fcfa15248a615f8b79b81aa8bf0c77b7a6eb extends Twig_Template
{
        ...
        if ($this->getAttribute(($context["collector"] ?? null), "symfonyversion", [], "any", true, true)) {
            ...
            echo "                <div class=\"sf-toolbar-info-piece\">
                    ...
                    <span>
                        ";
            // line 102
            if (("Silex" == $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "applicationname", []))) {
                // line 103
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/config.html.twig", "/Applications/MAMP/htdocs/SmartStartSymfony/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/config.html.twig");
    }
}
