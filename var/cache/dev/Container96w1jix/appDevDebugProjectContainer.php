...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/vendor/tiloweb/pagination-bundle/Tiloweb/PaginationBundle/Twig/Extension/PaginationExtension.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('zdeMQS-qea', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q1Rrwrwcf-', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nNMRaSUjcp', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ym98itPEJk', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/BlogBundle/Resources/views'), '!Blog');
        $instance->addPath(($this->targetDirs[3].'/vendor/tiloweb/pagination-bundle/Tiloweb/PaginationBundle/Resources/views'), 'TilowebPagination');
        $instance->addPath(($this->targetDirs[3].'/vendor/tiloweb/pagination-bundle/Tiloweb/PaginationBundle/Resources/views'), '!TilowebPagination');
        $instance->addPath(($this->targetDirs[3].'/src/AdminBundle/Resources/views'), 'Admin');
        $instance->addPath(($this->targetDirs[3].'/src/AdminBundle/Resources/views'), '!Admin');
        $instance->addPath(($this->targetDirs[3].'/src/QandABundle/Resources/views'), 'QandA');
        $instance->addPath(($this->targetDirs[3].'/src/QandABundle/Resources/views'), '!QandA');
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'TilowebPaginationBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/tiloweb/pagination-bundle/Tiloweb/PaginationBundle'),
                ...
                'QandABundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/QandABundle'),
                    'namespace' => 'QandABundle',
                ],
                'DebugBundle' => [
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'QandABundle' => 'QandABundle\\QandABundle',
